...
const VisionPage = () => {
  ...
  return (
    <div className="flex-auto relative bg-[#fa5252] overflow-x-hidden ">
      <p
        className={`uppercase text-[64px] leading-normal absolute inline-block top-5 right-[60px] stroketext text-transparent  ${archivo.className} `}
      >
        Vision map
      </p>

      <div className="flex items-center justify-center mt-[194px] relative z-20">
        <div className="flex flex-col">
          ...
          <p className="text-white text-center text-[18px] font-[300] leading-[28px] inline-block max-width max-w-[890px] mx-auto">
            A place where users can experience pet-related products and services
            at a new level through WEB3
          </p>
        </div>
      </div>
      ...
      <div className="w-[7680px] h-[211px] bg-bottom-foil overflow-hidden absolute bottom-0 z-1"></div>
    </div>
  );
};
