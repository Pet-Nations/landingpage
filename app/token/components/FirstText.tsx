...
const FirstText = () => {
  return (
    ...
    >
      ...
      <p className="font-bold	text-white inline-block text-[16px] font-[300] leading-6 opacity-[0.7] flex justify-start">Hold for more {" "} <p className="mt-[12px] ml-[12px] h-[1px] mx-[8px] bg-[#FF9F46] w-[40px]" /> <p className="max-w-[103px] font-light text-xs leading-6">Voting rights Heigher rank VIP club</p></p>
